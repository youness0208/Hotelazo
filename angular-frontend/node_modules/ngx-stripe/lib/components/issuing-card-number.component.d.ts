...
import { StripeElementsOptions, StripeElements, StripeIssuingCardNumberDisplayElementOptions, StripeIssuingCardNumberDisplayElement } from '@stripe/stripe-js';
import { NgxStripeElementLoadingTemplateDirective } from '../directives/stripe-element-loading-template.directive';
import { StripeElementsDirective } from '../directives/elements.directive';
import { StripeServiceInterface } from '../interfaces/stripe-instance.interface';
import { StripeElementsService } from '../services/stripe-elements.service';
import * as i0 from "@angular/core";
export declare class StripeIssuingCardNumberDisplayComponent implements OnInit, OnChanges, OnDestroy {
    private cdr;
